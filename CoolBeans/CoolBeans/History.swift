...
class History: ObservableObject {
    ...
    func add(_ drink: Drink, size: String, extraShots: Int, isDecaf: Bool, milk: ConfigurationOption, syrup: ConfigurationOption, coffeine: Int, calories: Int) {
        ...
        let serving = Serving(id: UUID(), name: drink.name, description: descriptionString, coffeine: coffeine, calories: calories)
